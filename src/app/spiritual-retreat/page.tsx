...
const page = () => {
  const sampleCardData = [
    {
      src: imageUrl + "spiritual/rebalance1.webp",
      alt: "Abhyanga Therapy",
      name: "Abhyanga Therapy",
    },
    {
      src: imageUrl + "spiritual/rebalance2.webp",
      alt: "Guided Meditation",
      name: "Guided Meditation",
    },
    {
      src: imageUrl + "spiritual/rebalance3.webp",
      alt: "Spiritual Sessions",
      name: "Spiritual Sessions",
    },
    {
      src: imageUrl + "spiritual/rebalance4.webp",
      alt: "Hydrotherapy",
      name: "Hydrotherapy",
    },
    {
      src: imageUrl + "spiritual/rebalance5.webp",
      alt: "Reflexology",
      name: "Reflexology",
    },
    {
      src: imageUrl + "spiritual/rebalance6.webp",
      alt: "Physiotherapy",
      name: "Physiotherapy",
    },
    {
      src: imageUrl + "spiritual/rebalance7.webp",
      alt: "Shirodhara",
      name: "Shirodhara",
    },
    {
      src: imageUrl + "spiritual/rebalance8.webp",
      alt: "AcCupressure",
      name: "AcCupressure",
    },
    {
      src: imageUrl + "spiritual/rebalance9.webp",
      alt: "Sun Therapy",
      name: "Sun Therapy",
    },
    {
      src: imageUrl + "spiritual/rebalance10.webp",
      alt: "Sound Healing",
      name: "Sound Healing",
    },
  ];
  const weOfferData = [
    {
      ...
      description:
        "Calm your mind through yoga, meditation, and relaxation techniques",
    },
    {
      src: imageUrl + "spiritual/cleanse2.webp",
      alt: "Weight and Metabolic Management",
      description:
        "Achieve your health goals with tailored diets and holistic therapies",
    },
    {
      src: imageUrl + "spiritual/cleanse3.webp",
      alt: "Diabetes Care",
      description:
        "Natural approaches to support and stabilize blood sugar levels.",
    },
    {
      src: imageUrl + "spiritual/cleanse4.webp",
      alt: "Sleep Management",
      description:
        "Improve sleep quality with holistic treatments and relaxation.",
    },
    {
    ...
    },
    {
      ...
      description:
        " Cleanse and revitalize with Ayurvedic and naturopathic treatments.",
    },
  ];
  return (
    <div>
      <FullScreenCarousel
        data={[imageUrl + "273A8478.webp", imageUrl + "IMG_8234.webp"]}
      ...
      <div className="bg-[#F9F9F1]">
        ...
        <SectionWithContainer>
          <div className="flex flex-col gap-5">
            ...
            <p className="roboto font-light text-center text-[20px] lg:max-w-[956px] mx-auto max-md:px-3 mb-8">
              We offer a range of therapies that draw on the power of nature and
              ancient traditions. These are administered under the guidance of
              Ayurveda / Naturopathy doctors, by skilled therapists.
            </p>
