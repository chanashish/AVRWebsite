    ...
    <>
      <div className="flex flex-col md:flex-row w-full lg:mt-20 gap-[32px] max-md:p-4 max-w-[1224px] mx-auto place-content-between">
        <div className="flex-1 max-w-[704px]">
          <p className="text-[22px] font-normal uppercase roboto text-[#2F4B26]">
            anand vardhan resort
          </p>
          <h2 className="text-[40px] font-normal mt-2 mb-4 playfair text-[#2F4B26]">
            Have a question for us?
          </h2>
          <p className="text-[#686767] roboto font-light text-[20px] mb-6">
            You know what to do! Drop us a line and we&apos;ll get back to you
            as soon as possible.
          </p>
        ...
        <div className="flex-1 max-w-[354px]">
          <h2 className="text-[22px] font-normal text-[#2F4B26] mb-2 roboto">
            Contact
          </h2>
          ...
          <p className="mb-1 text-[#686767] font-light text-[20px]">
            Email:{" "}
            <Link href="mailto:sales@anandvardhanresorts.com">
              sales@anandvardhanresorts.com
            </Link>
          </p>
