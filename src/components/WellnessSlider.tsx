    ...
    <section className="max-w-[1600px] mx-auto py-20 w-full max-md:px-12 max-md:py-24 max-sm:px-6 max-sm:py-16 bg-[#F9F9F1]">
          ...
          <div className="flex max-lg:flex-wrap lg:overflow-auto place-content-between gap-4 sm:gap-6 max-lg:justify-center py-[16px] mt-8 facility-map-border">
            {facility.map((item) => (
              ...
              >
                ...
                <span className="text-[#686767] text-[18px] roboto uppercase font-normal whitespace-nowrap overflow-hidden text-ellipsis">
                  {item.name}
                </span>
              </div>
            ))}
      ...
      {roomdescription ? (
        <Link
          ...
          target="blank"
          className="sm:flex items-center hidden mt-7 justify-center cursor-pointer hover:underline"
        >
          ...
          (roomdescription ? (
            <Link
              ...
              className={`flex gap-2 items-center cursor-pointer hover:underline ${
                !reverseLayout ? "mr-auto" : ""
              }`}
            >
              <span className="text-lg leading-6 text-neutral-700">
                Book Now
              </span>
              <svg
                width="25"
