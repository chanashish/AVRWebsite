...
const BookingForm = () => {
  ...
  return (
    <section className="flex flex-col gap-6 justify-center items-center px-0 pt-14 pb-20 border-t border-solid bg-[#F9F9F1] border-t-neutral-400 max-sm:px-4 max-sm:py-8">
      ...
      >
        ...
        {/* Room Type Dropdown */}
        <div className="relative flex items-center px-4 py-5 max-md:w-full max-md:border-b cursor-pointer" ref={roomDropdownRef} onClick={() => setRoomDropdownOpen(!roomDropdownOpen)}>
        ...
        {/* Submit Button */}
        <button type="submit" className="px-2 py-5 text-lg leading-6 text-white bg-lime-900 rounded-none w-[120px] max-md:w-full">
          Book Now
        </button>
      </form>
    </section>
