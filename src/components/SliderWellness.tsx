        ...
        <div className="max-w-7xl mx-auto px-4 bg-[#F9F9F1]">
            <div className="mt-10 flex flex-wrap w-full">
                <div className="w-full">
                    <div className="wow fadeInUp mx-auto overflow-hidden rounded-md" data-wow-delay=".15s">
                        <Swiper
                            autoplay={{
                                delay: 2000,
...
export const PrevBtnArrow = () => (
    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M26.6673 35.1663L28.084 33.7497L14.334 19.9997L28.084 6.24967L26.6673 4.83301L11.5007 19.9997L26.6673 35.1663Z" fill="#363636" />
    </svg>
);

export const NextBtnArrow = () => (
    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M13.3327 35.1663L11.916 33.7497L25.666 19.9997L11.916 6.24967L13.3327 4.83301L28.4993 19.9997L13.3327 35.1663Z" fill="#363636" />
    </svg>
);
